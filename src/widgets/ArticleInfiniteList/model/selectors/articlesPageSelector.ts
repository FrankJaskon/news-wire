...
export const geInitialized = (state: StateSchema) =>
	state?.articlesInfiniteList?._initialized || false
...
export const getFilter = (state: StateSchema) =>
	state?.articlesInfiniteList?.filter || ArticlesTypes.ALL
